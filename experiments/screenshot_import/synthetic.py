...
def scenarios() -> dict[str, SyntheticScenario]:
    return {
        "standard_10": SyntheticScenario(
            ...
            section_count=10,
            courses=(
                SyntheticCourse(1, 1, 2, ("通信原理", "1-8周", "张老师", "A101"), (220, 240, 255)),
                SyntheticCourse(3, 3, 4, ("信息论", "1-15周(单)", "李明", "逸夫楼203"), (235, 225, 255)),
                SyntheticCourse(5, 5, 6, ("数字信号处理", "1-16周(双)", "王老师"), (220, 250, 225)),
                SyntheticCourse(2, 7, 8, ("计算机网络", "1-8,10-16周", "赵老师", "B204"), (255, 235, 215)),
        ...
        "tilted_12": SyntheticScenario(
            ...
            scale=0.86,
            courses=(
                SyntheticCourse(4, 2, 4, ("高频电子技术", "第1-8周", "刘老师", "教学楼C302"), (220, 240, 255)),
                SyntheticCourse(6, 6, 8, ("单片机原理", "1-15周(单)", "周老师", "逸夫楼405"), (235, 225, 255)),
                SyntheticCourse(7, 9, 10, ("数字电路", "2-16周(双)", "孙老师", "D101"), (220, 250, 225)),
                SyntheticCourse(1, 11, 12, ("通信与网络", "1-16周", "吴老师"), (255, 235, 215)),
            ),
        ),
    }
...
def generate_synthetic_sample(
    ...
    margin, header_height, row_height = 28, 68, 68
    ...
    for x in x_lines:
        draw.line((x, y0, x, y0 + table_height), fill=(65, 75, 85), width=2)
    for y in y_lines:
        draw.line((x0, y, x0 + table_width, y), fill=(65, 75, 85), width=2)
