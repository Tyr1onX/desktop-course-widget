...
assert.match(widgetPageSource, /COURSE_EXIT_MS = 1450/)
assert.match(widgetPageSource, /COURSE_MORPH_DELAY_MS = 420/)
assert.match(widgetPageSource, /COURSE_MORPH_MS = 2300/)
...
console.log('presentation clock, shared-course FLIP morphs, single-shell resizing, controller, and widget wiring checks passed')
