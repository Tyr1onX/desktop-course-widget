...
assert.match(widgetPageSource, /COURSE_TRANSITION_SETTLE_MS = 1800/)
...
assert.match(widgetPageCss, /animation-duration: 1960ms/)
assert.match(widgetPageCss, /replay-focus-out 1320ms/)
assert.match(widgetPageCss, /replay-focus-in 1440ms[^\n]*520ms/)
assert.match(widgetPageCss, /mix-blend-mode: normal/)
assert.match(widgetPageCss, /z-index: 2/)
assert.match(widgetPageCss, /\.is-presentation-replay \.focus-course[\s\S]*animation: none/)
...
console.log('presentation clock, stable minute updates, visible slow handoffs, controller, and widget wiring checks passed')
