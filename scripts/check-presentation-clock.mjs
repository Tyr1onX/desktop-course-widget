...
assert.match(widgetPageSource, /COURSE_SHARED_TEXT_MOVE_MS = 1120/)
assert.match(widgetPageSource, /COURSE_CARD_FORM_MS = 1120/)
assert.match(widgetPageSource, /COURSE_LINE_REVEAL_MS = 820/)
assert.match(widgetPageSource, /COURSE_TEXT_HANDOFF_MS = 90/)
...
assert.match(widgetPageSource, /function prepareLineReveal/)
...
assert.match(widgetPageSource, /lineRevealParts/)
assert.match(widgetPageSource, /softRevealParts/)
assert.match(widgetPageSource, /course-line-reveal-stroke/)
assert.match(widgetPageSource, /clipPath: 'inset\(0 100% 0 0\)'/)
assert.match(widgetPageSource, /duration: COURSE_LINE_REVEAL_MS/)
assert.match(widgetPageSource, /await Promise\.all\(\[[\s\S]*sharedMotions\.map[\s\S]*animateElement\(morph[\s\S]*targetTimeExtension[\s\S]*lineRevealParts\.flatMap/)
...
assert.match(widgetPageCss, /\.course-line-reveal-stroke/)
assert.match(widgetPageCss, /will-change: clip-path, opacity, transform/)
...
console.log('presentation clock, shared start-time growth, line-reveal final-card handoff, duration formatting, controller, and widget wiring checks passed')
